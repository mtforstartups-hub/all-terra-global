import { ContactFormProps } from "@/types/formSchema";
...
export const getContactFormNotificationHtml = (data: ContactFormProps) => {
  ...
  const safe = {
    ...
    investmentInterest: escapeHtml(data.investment_interest),
    amount: data.amount ? escapeHtml(data.amount) : undefined,
