      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="gp-content opacity-0">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-[#F8AB1D] text-secondary px-6 py-3 rounded-xl font-semibold hover:bg-[#d99310] transition-all hover:-translate-y-1"
            >
              Connect with Raahuul
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
