...
export default function GlobalPresence() {
    ...
    const locations: Location[] = [
        { id: "harare", name: "Harare", country: "Zimbabwe", role: "Operations Hub", x: 540, y: 340, isTarget: true },
        { id: "dubai", name: "Dubai", country: "UAE", role: "Global HQ", x: 600, y: 240 },
        { id: "usa", name: "New York", country: "USA", role: "Investor Relations", x: 200, y: 200 },
        { id: "india", name: "Mumbai", country: "India", role: "Tech & Analytics", x: 660, y: 280 },
    ];
    ...
    useGSAP(
        () => {
            ...
            const pathElements = gsap.utils.toArray<SVGPathElement>(".connection-path");
            ...
            gsap.utils.toArray<SVGCircleElement>(".flow-particle").forEach((particle, index) => {
                const path = document.querySelectorAll(".connection-path")[index] as SVGPathElement;
                if (!path) return;
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-white/60 max-w-2xl mx-auto">
                        ...
                        channeling resources toward Zimbabwe's growth potential.
                    </p>
                </div>
                        ...
                        >
                            <defs>
                                ...
                                <pattern id="fineGrid" width="5" height="5" patternUnits="userSpaceOnUse">
                                    <circle cx="2.5" cy="2.5" r="0.3" fill="rgba(28, 82, 68, 0.1)" />
                                </pattern>
                            ...
                            <g className="target-highlight">
                                ...
                                {/* Crosshairs */}
                                <line x1="540" y1="300" x2="540" y2="320" stroke="#F8AB1D" strokeWidth="2" />
                                <line x1="540" y1="360" x2="540" y2="380" stroke="#F8AB1D" strokeWidth="2" />
                                <line x1="500" y1="340" x2="520" y2="340" stroke="#F8AB1D" strokeWidth="2" />
                                <line x1="560" y1="340" x2="580" y2="340" stroke="#F8AB1D" strokeWidth="2" />
                            ...
                            {locations.map((loc) => (
                                ...
                                >
                                    ...
                                    <circle
                                        ...
                                        style={{
                                            transform: activeLocation === loc.id ? "scale(1.3)" : "scale(1)",
                            ...
                            <g transform="translate(60, 390)" opacity="0.4">
                                <circle cx="0" cy="0" r="20" fill="none" stroke="#1C5244" strokeWidth="1" />
                                <line x1="0" y1="-25" x2="0" y2="25" stroke="#1C5244" strokeWidth="1" />
                                <line x1="-25" y1="0" x2="25" y2="0" stroke="#1C5244" strokeWidth="1" />
                                <text x="0" y="-30" textAnchor="middle" fill="#1C5244" fontSize="8" fontWeight="bold">N</text>
                            </g>

                            {/* Scale indicator */}
                            <g transform="translate(700, 420)" opacity="0.4">
                                <line x1="0" y1="0" x2="60" y2="0" stroke="#1C5244" strokeWidth="1" />
                                <line x1="0" y1="-3" x2="0" y2="3" stroke="#1C5244" strokeWidth="1" />
                                <line x1="60" y1="-3" x2="60" y2="3" stroke="#1C5244" strokeWidth="1" />
                                <text x="30" y="12" textAnchor="middle" fill="#1C5244" fontSize="7">TACTICAL VIEW</text>
                            </g>
                        </svg>
                    </div>
                    ...
                    <div className="absolute bottom-4 left-4 flex items-center gap-6 text-white/60 text-xs">
                        ...
                        <div className="flex items-center gap-2">
                            <svg width="24" height="10">
                                <path d="M 0 5 L 20 5" stroke="#F8AB1D" strokeWidth="2" markerEnd="url(#arrowhead)" />
                            </svg>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-12">
                    {locations.map((loc) => (
                        <div
                            key={loc.id}
                            className={`location-card p-6 rounded-2xl border transition-all duration-300 cursor-pointer ${loc.isTarget
                        ...
                        >
                            ...
                            <p className={`text-sm mt-2 ${loc.isTarget ? "text-[#F8AB1D]" : "text-[#1C5244]"}`}>
                                {loc.role}
                            </p>
                        </div>
                    ))}
