...
export default function GlobalPresence() {
    ...
    const locations: Location[] = [
        { id: "dubai", name: "Dubai", country: "UAE", x: 445, y: 200, isHQ: true },
        { id: "harare", name: "Harare", country: "Zimbabwe", x: 390, y: 310 },
        { id: "usa", name: "New York", country: "USA", x: 200, y: 170 },
        { id: "india", name: "Mumbai", country: "India", x: 480, y: 230 },
    ];
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        {locations.map((loc) => {
                            ...
                            const pinColor = isHarare ? "#22c55e" : (isDubai ? "#F8AB1D" : "#1C5244");
                            const pinScale = isHarare ? 1.3 : (isDubai ? 1 : 0.7);
                            const glowColor = isHarare ? "rgba(34, 197, 94, 0.6)" : "rgba(248, 171, 29, 0.5)";

                            // Pin shape path (centered at bottom tip 0,0)
                            const pinPath = "M0 0 C -2 -10, -10 -15, -10 -22 A 10 10 0 1 1 10 -22 C 10 -15, 2 -10, 0 0 Z";
