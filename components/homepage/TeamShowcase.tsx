        ...
        >
          <div className={`${isMobile ? "" : "h-screen"} flex items-center`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              ...
              <div
                className={`member-${member.id} flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-center`}
              >
                {/* Photo */}
                <div className="relative w-full">
                  <div className="relative aspect-[4/3] lg:aspect-[3/4] lg:max-h-[70vh] rounded-2xl lg:rounded-3xl overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 lg:p-8">
                      ...
                      <p className="text-[#F8AB1D] font-medium text-sm lg:text-base mt-1">
                        {member.title}
                      </p>
                ...
                <div className="space-y-4 lg:space-y-6 w-full">
                  ...
                  <div className="grid grid-cols-3 gap-2 lg:gap-3">
                    {member.achievements.map((achievement, index) => (
                      ...
                      >
                        ...
                        <div className="text-base lg:text-2xl font-bold text-[#F8AB1D]">
                          {achievement.value}
                        </div>
                        <div className="text-white/50 text-[10px] lg:text-xs mt-0.5 lg:mt-1">
                          {achievement.label}
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="sectors-container opacity-0">
                    <p className="text-white/50 text-xs lg:text-sm mb-2 lg:mb-3">
                      Key Sectors:
                    </p>
